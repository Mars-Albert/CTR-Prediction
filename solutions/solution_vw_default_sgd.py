...
results_path='output/results/online/solution_vw_default_sgd.py/'

os.makedirs(results_path)


#训练
cmd='vw output/online.vw -p {path}preds.txt -P 20000 --loss_function logistic'.format(path=results_path)
