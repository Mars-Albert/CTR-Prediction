...
cmd='python feature_engineering/csv2vw_normalized_categorical.py {0} {1} '.format(data_path,result_path)
subprocess.call(cmd,shell=True,stdout=subprocess.PIPE)


cmd='vw {path}train.vw  -f {path}model --bfgs -c -k --passes 25 -b 20  --quiet --loss_function logistic --l2 25 --termination 1e-5  --holdout_off'.format(path=result_path)
